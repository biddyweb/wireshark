...
#define CTP_OPTIONS_OFFSET 0
#define CTP_OPTIONS_LEN 1
...
#define CTP_STATS_ITEM_LEN 7

#define CTP_STATS_SIZE_LEN 1
#define CTP_STATS_NUM_LEN 1
#define CTP_STATS_NODE_FIELD_LEN 1

#define CTP_PULL_FLAG 0x80
#define CTP_CONGESTION_FLAG 0x40
#define CTP_STATS_FLAG 0x01

#define CTP_ROUTING_PARENT_OFFSET (CTP_OPTIONS_OFFSET+CTP_OPTIONS_LEN)
...
#define CTP_THL_OFFSET (CTP_OPTIONS_OFFSET+CTP_OPTIONS_LEN)
...
#define CTP_DATA_STATS_OFFSET (CTP_DATA_COLLECT_ID_OFFSET+CTP_COLLECT_ID_LEN)
